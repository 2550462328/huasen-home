...
const dashboardOverview = post('/manage/dashboard/overview');
const dashboardPvTrend = post('/manage/dashboard/pvTrend');
const dashboardArticleRank = post('/manage/dashboard/articleRank');
...
export { login, findManageByPage, addManage, removeManage, updateManage, uploadFile, overview, diskOverview, visitor, dashboardOverview, dashboardPvTrend, dashboardArticleRank, executeRuntimeCode, findAppConfig, saveAppConfig, findAppFavicon };
