      ...
      let state = {
        appConfig: {
          ...
          site: {
            ...
            redirectURL: that.LODASH.get(res.data, 'site.redirectUrl') || 'https://www.huitogo.club/',
            guidePageName: that.LODASH.get(res.data, 'site.guidePageName') || '花森小窝',
            guidePageUrl: that.LODASH.get(res.data, 'site.guidePageUrl') || 'https://www.huitogo.club/',
